...
import os as _os
_OR_USER_MODEL = _os.environ.get("OPENROUTER_USER_MODEL", "openrouter/openai/gpt-4o-mini")
DEFAULT_LLM_AGENT = _OR_USER_MODEL
DEFAULT_LLM_USER = _OR_USER_MODEL
...
DEFAULT_LLM_NL_ASSERTIONS = _OR_USER_MODEL
...
DEFAULT_LLM_ENV_INTERFACE = _OR_USER_MODEL
