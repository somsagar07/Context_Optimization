#!/usr/bin/env python3
"""
DSPy prompt evaluation script for testing optimized prompts.
Loads a saved prompt JSON file, extracts instructions, and evaluates using base model.
